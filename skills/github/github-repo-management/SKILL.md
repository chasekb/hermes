...
# From existing local directory and push in one step
...
This is the fastest path when the local repo already exists: it creates the GitHub repo, adds `origin`, and pushes the current branch immediately.
