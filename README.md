...
`main` is the canonical branch for this control-plane repository.
...
The installed upstream source is `/home/kahlil/.hermes/hermes-agent` from `NousResearch/hermes-agent`. The canonical architecture and Kanban scope are documented in `notes/Projects/hermes/Hermes Agent Decision Plane.md`.
