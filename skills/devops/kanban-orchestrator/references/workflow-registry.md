...
| obsidian-context-layer | Durable project continuity is needed without loading a whole vault | Project index, linked notes, current turn summary | Selective note retrieval plan and write-back summary | Start from the project index, then update the session summary and decision log | Revision |
